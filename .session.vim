...
nnoremap <silent> <F2> :NERDTreeTabsToggle
nnoremap <silent> <S-F2> :NERDTreeFocusToggle
...
nnoremap <SNR>45_: :=v:count ? v:count : ''
...
setlocal spellfile=
setlocal spelllang=ru_yo,en_us,sv
